class Post extends React.Component {
  ...
  render() {
    ...
    let address = this.state.editable ? <input type='text' href={showLink} ref={input => this.address = input} defaultValue={this.props.post.address} className="form-control" /> : <p>{this.props.post.address}</p>
    return (
      <div>
        {blog}
        {address}
